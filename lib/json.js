...
exports.Poi = {
    _id: 0,
    // Number，标签数据库id，整数，对外显示ID形式为‘Pxxx’，其中x为id字母表字符，长度>=3
    poi: '',
    // String，地点名称，英文单词或中文词组（大于两个字）
    articles: 0,
    // Number，包含的文章数量
    articlesList: [],
    // Array，包含文章的_id列表数组
